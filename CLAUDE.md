...
## Project Overview
This is a simple static website for the Three Tasks app support page. It consists of two HTML files with inline CSS styling:
...
### Deployment
This is a simple static site that can be deployed directly to any web server or static hosting service (GitHub Pages, Netlify, etc.)

### Key Information
- Contact email: kuanhao.su@gmail.com
- App name: Three Tasks (a minimalist task manager app)
